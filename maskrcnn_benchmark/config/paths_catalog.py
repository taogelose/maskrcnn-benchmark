...
class DatasetCatalog(object):
    ...
    DATASETS = {
        ...
        "coco_HumanCollection_mini_trainval": (
            "/mnt/data1/Dataset/HW_dataset/HumanCollection_mini/coco/HC_mini_trainval",
            "/mnt/data1/Dataset/HW_dataset/HumanCollection_mini/coco/annotations/instances_HC_mini_trainval.json",
            "/mnt/data1/Dataset/HW_dataset/HumanCollection_mini/voc/Instances",
        ),
        "coco_HumanCollection_mini_test": (
            "/mnt/data1/Dataset/HW_dataset/HumanCollection_mini/coco/HC_mini_test",
